...
if ( ! defined( 'smartcontentai_PATH' ) ) {
    define( 'smartcontentai_PATH', ABSPATH . 'includes/' );
}

if ( ! defined( 'smartcontentai_VERSION' ) ) {
    define( 'smartcontentai_VERSION', '1.0.0' );
}

if ( ! defined( 'smartcontentai_TABLE_LOGS' ) ) {
...
if ( ! isset( $GLOBALS['wpdb'] ) ) {
    class smartcontentai_Mock_WPDB {
        ...
        private function extract_table_name( $query ) {
            ...
            return $this->prefix . 'smartcontentai_logs';
        }
    ...
    $GLOBALS['wpdb'] = new smartcontentai_Mock_WPDB();
}
