...
class GeminiLayerClientTest extends TestCase {
    public function test_http_transport_error_redacts_api_key() {
        ...
        $this->assertEquals( 'smartcontentai_http_transport_error', $result->get_error_code() );
    ...
    public function test_http_429_maps_to_rate_limited_error() {
        ...
        $this->assertInstanceOf( 'WP_Error', $result );
        $this->assertEquals( 'smartcontentai_rate_limited', $result->get_error_code() );
    }
    ...
    public function test_rate_limiter_waits_when_over_limit() {
        ...
        $slept = array();
        $store = array(
            'smartcontentai_gemini_rate_history' => array( 950, 980 ),
        );
        ...
        $this->assertContains( 1010, $store['smartcontentai_gemini_rate_history'] );
    }
}
